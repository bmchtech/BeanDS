...
final class MMIO9 {
    ...
    Byte read_byte(Word address) {
        switch (address) {
            ...
            case IME + 2: return interrupt7.read_IME (2);
            case IME + 3: return interrupt7.read_IME (3);
    ...
    void write_byte(Word address, Byte data) {
        switch (address) {
            ...
            case IPCFIFOCNT  + 0: ipc.write_IPCFIFOCNT  (0, data, IPCSource.ARM9); break;
            case IPCFIFOCNT  + 1: ipc.write_IPCFIFOCNT  (1, data, IPCSource.ARM9); break;
            case IPCFIFOCNT  + 2: ipc.write_IPCFIFOCNT  (2, data, IPCSource.ARM9); break;
            case IPCFIFOCNT  + 3: ipc.write_IPCFIFOCNT  (3, data, IPCSource.ARM9); break;
            case IPCFIFOSEND + 0: ipc.write_IPCFIFOSEND (0, data, IPCSource.ARM9); break;
            case IPCFIFOSEND + 1: ipc.write_IPCFIFOSEND (1, data, IPCSource.ARM9); break;
            case IPCFIFOSEND + 2: ipc.write_IPCFIFOSEND (2, data, IPCSource.ARM9); break;
            case IPCFIFOSEND + 3: ipc.write_IPCFIFOSEND (3, data, IPCSource.ARM9); break;

            case IME + 0: interrupt9.write_IME (0, data); break;
            case IME + 1: interrupt9.write_IME (1, data); break;
            case IME + 2: interrupt7.write_IME (2, data); break;
            case IME + 3: interrupt7.write_IME (3, data); break;
